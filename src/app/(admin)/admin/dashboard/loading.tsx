...
export default function AdminLoading() {
  return (
    // use absulate inset-0 to cover the entire page and show a loading spinner in the center
    <div className="absolute inset-0 z-50 flex flex-col items-center justify-center bg-white/60 dark:bg-gray-900/60 backdrop-blur-sm rounded-xl">
